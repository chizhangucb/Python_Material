...
# Singleton Objects: A class that only ever has one instance.
...
# Linked lists (review)
# Streams are lazy linked lists: the rest of the list is computed on demand =:
...
st = Stream(1, lambda: Stream(1/))
st.first # 1
st.rest  # Error because of 1/0

# An integer stream is a stream of consective integers.
...
# While filtering a stream, processing continues until an element is kept in the output
