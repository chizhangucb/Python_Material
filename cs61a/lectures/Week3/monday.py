...
def area(r, shape_constant):
    ...
    # A message if it is not true. Very useful checking method
...
def make_adder(n):
    ...
    7
    """
    # Functions defined wiithin other function bodies are bound to names
    def adder(k):
        return k + n
    return adder
...
# 1. Funtions are first-class: functions can be manipulated as values in python
# 2. Higher-order function: a function that takes a function as an argument
